...
class ResNet(nn.Module):
    def __init__(self, architecture, num_classes):
        ...
        self.stage1 = self.add_stage(in_channels=64, out_channels=64, stride=1, blocks_count=blocks[0])
        self.stage2 = self.add_stage(in_channels=64, out_channels=128, stride=2, blocks_count=blocks[1])
        self.stage3 = self.add_stage(in_channels=128, out_channels=256, stride=2, blocks_count=blocks[2])
        self.stage4 = self.add_stage(in_channels=256, out_channels=512, stride=2, blocks_count=blocks[3])
